      ...
      <View style={styles.container}>
        ...
        <View style={styles.RowContainer}>
          <Text style={styles.details}>
            * Feeding: Eating mashed foods, finger foods introduction
          </Text>
          <Text style={styles.details}>
            * Sleep: 10-14 hours, may have separation anxiety
          </Text>
          <Text style={styles.details}>
            * Health: Watch for choking hazards, teething discomfort
          </Text>
          <Text style={styles.details}>
            * Milestones: Pulling up to stand, understanding "no"
          </Text>
        </View>
        <View
          id={"Supplement"}
        ...
        >
          ...
          <View style={styles.ColumnContainer}>
            ...
            <Text style={styles.details}>
              * Foods: Sweet potatoes, beans, lentils, oranges
            </Text>
            <Text style={styles.details}>
              * Drinks: Beetroot juice, electrolyte-rich drinks
            </Text>
          </View>
        </View>
        <View
        ...
        >
          ...
          <View style={styles.ColumnContainer}>
            ...
            <Text style={styles.details}>
              * Physical: Butterfly stretches and sitting cat-cow poses
            </Text>
            <Text style={styles.details}>
              * Mental: Spending time in nature for relaxation
            </Text>
          </View>
        </View>
        <View>
        ...
        >
          ...
          <View style={styles.ColumnContainer}>
            ...
            <Text style={styles.details}>
              * Foods: Leafy greens, beans, oranges, fortified cereals Drinks:
              Fresh orange juice, plenty of water
            </Text>
          </View>
        </View>
      </View>
