    ...
    <ScrollView style={styles.scroll}>
      <View style={styles.container}>
        ...
        <View style={styles.banner}>
          <Image
            source={require("./../../../assets/images/7month baby.png")}
        ...
        <View style={styles.RowContainer}>
          <Text style={styles.details}>
            * Feeding: More solid food variety, but still mainly milk
          </Text>
          <Text style={styles.details}>
            * Sleep: 10-14 hours, may wake up at night due to teething
          </Text>
          <Text style={styles.details}>
            * Health: Keep baby-proofing home as movement increases
          </Text>
          <Text style={styles.details}>
        ...
        >
          ...
          <View style={styles.ColumnContainer}>
            ...
            <Text style={styles.details}>
              * Foods: Eggs, peanuts, lean meats, whole grains
            </Text>
            <Text style={styles.details}>
              * Drinks: Banana smoothies, coconut water
            </Text>
          </View>
        </View>
        <View
        ...
        >
          ...
          <View style={styles.ColumnContainer}>
            ...
            <Text style={styles.details}>
              * Physical: Light prenatal dance or low-impact aerobics
            </Text>
            <Text style={styles.details}>
              * Mental: Gratitude journaling to stay positive
            </Text>
          </View>
        </View>
        <View>
          ...
          <View style={styles.ColumnContainer}>
            ...
            <Text style={styles.details}>
              * Probiotics – Supports digestion and prevents infections. –
              Supports digestion and prevents infections.
            </Text>
            <Text style={styles.details}>
              * Rh Immunoglobulin (If Rh-negative blood type) – Prevents
