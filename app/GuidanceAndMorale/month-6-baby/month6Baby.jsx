    ...
    <ScrollView style={styles.scroll}>
      <View style={styles.container}>
        ...
        <View style={styles.banner}>
          <Image
            source={require("./../../../assets/images/6month baby.png")}
        ...
        <View style={styles.RowContainer}>
          ...
          <Text style={styles.details}>
            * Sleep: 10-14 hours, better nighttime routine
          </Text>
          <Text style={styles.details}>
        ...
        >
          ...
          <View style={styles.ColumnContainer}>
            ...
            <Text style={styles.details}>
              * Foods: Avocados, nuts, dark chocolate, bananas
            </Text>
            <Text style={styles.details}>
              * Drinks: Herbal teas (ginger, chamomile)
            </Text>
          </View>
        </View>
        <View
        ...
        >
          ...
          <View style={styles.ColumnContainer}>
            ...
            <Text style={styles.details}>
              * Physical: Kegel exercises for pelvic floor strengthening
            </Text>
            <Text style={styles.details}>
              * Mental: Reading books about pregnancy and self-care
            </Text>
          </View>
        </View>
        <View>
        ...
        >
          ...
          <View style={styles.ColumnContainer}>
            ...
            <Text style={styles.details}>
              * No additional vaccines, continue regular checkups.
            </Text>
          </View>
        </View>
      </View>
