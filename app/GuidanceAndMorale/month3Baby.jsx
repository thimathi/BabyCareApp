        ...
        <ScrollView style={styles.scroll}>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.banner}>
                    <Image source={require("../../assets/images/3month baby.png")}
                ...
                <View style={styles.RowContainer}>
                    <Text style={styles.details}>* Feeding: Breastfeeding/formula every 3-4 hours</Text>
                    <Text style={styles.details}>* Sleep: 12-16 hours, better nighttime sleep patterns</Text>
                    <Text style={styles.details}>* Health: Monitor weight gain, tummy time to prevent flat head</Text>
                    <Text style={styles.details}>* Milestones: Recognizes parents, holds head up, starts grasping objects</Text>
                </View>
                <View id={"Supplement"} style={{flexDirection: 'row',backgroundColor: '#fffa85',borderRadius: 20,padding: 20,marginTop: 2,alignItems: 'center'}}>
                    ...
                    <View style={styles.ColumnContainer}>
                        ...
                        <Text style={styles.details}>* Physical: Brisk walking (15-20 minutes) and prenatal yoga</Text>
                        <Text style={styles.details}>* Foods: Milk, cheese, yogurt, almonds</Text>
                        <Text style={styles.details}>* Drinks: Fortified milk, fresh coconut water</Text>
                    </View>
                ...
                <View id={"Exercises"} style={{flexDirection: 'row',backgroundColor: '#C0DEFF',borderRadius: 20,padding: 20,marginTop: 10,alignItems: 'center'}}>
                    ...
                    <View style={styles.ColumnContainer}>
                        ...
                        <Text style={styles.details}>* Mental: Journaling to track mood and thoughts</Text>
                    </View>
                ...
                <View id={"Medicines & Vaccines  "} style={{flexDirection: 'row',backgroundColor: '#ADF2F6',borderRadius: 20,padding: 20,marginTop: 10,alignItems: 'center'}}>
                    ...
                    <View style={styles.ColumnContainer}>
                        ...
                        <Text style={styles.details}>* Vitamin D & Calcium – Supports bone development. Flu Vaccine (If flu season) – Protects mother and baby from complications.</Text>
