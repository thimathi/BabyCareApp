        ...
        <ScrollView style={styles.scroll}>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.Topheader}>
                    <TouchableOpacity onPress={() => router.push("./../guidance-main-panel")}>
                ...
                <View style={styles.banner}>
                    <Image source={require("./../../../assets/images/2month baby.png")}
                ...
                <View style={styles.RowContainer}>
                    <Text style={styles.details}>* Feeding: More frequent feeding, growth spurt</Text>
                    <Text style={styles.details}>* Sleep: 14-16 hours, starting to sleep longer at night</Text>
                    <Text style={styles.details}>* Health: First full vaccination set (DTaP, Polio, Hepatitis B, etc.)</Text>
                    <Text style={styles.details}>* Milestones: Starts smiling, cooing sounds, improved eye contact</Text>
                </View>
                <View id={"Supplement"} style={{flexDirection: 'row',backgroundColor: '#fffa85',borderRadius: 20,padding: 20,marginTop: 2,alignItems: 'center'}}>
                    ...
                    <View style={styles.ColumnContainer}>
                        ...
                        <Text style={styles.details}>* Iron & Vitamin C – Prevents anemia and boosts immunity</Text>
                        <Text style={styles.details}>* Foods: Lean meats, spinach, lentils, citrus fruits</Text>
                        <Text style={styles.details}>* Drinks: Lemon water, smoothies with berries</Text>
                    </View>
                ...
                <View id={"Exercises"} style={{flexDirection: 'row',backgroundColor: '#C0DEFF',borderRadius: 20,padding: 20,marginTop: 10,alignItems: 'center'}}>
                    ...
                    <View style={styles.ColumnContainer}>
                        ...
                        <Text style={styles.details}>* Physical: Gentle stretching and pelvic tilts to ease back pain</Text>
                        <Text style={styles.details}>* Mental: Meditation for 5-10 minutes daily</Text>
                    </View>
                ...
                <View id={"Medicines & Vaccines  "} style={{flexDirection: 'row',backgroundColor: '#ADF2F6',borderRadius: 20,padding: 20,marginTop: 10,alignItems: 'center'}}>
                    ...
                    <View style={styles.ColumnContainer}>
                        ...
                        <Text style={styles.details}>* Iron Supplements – Prevents anemia and supports baby’s growth.</Text>
                        <Text style={styles.details}>* No specific vaccines unless at high risk of infection.</Text>
