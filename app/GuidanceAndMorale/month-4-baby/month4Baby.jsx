        ...
        <ScrollView style={styles.scroll}>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.banner}>
                    <Image source={require("./../../../assets/images/4month baby.png")}
                ...
                <View id={"Supplement"} style={{flexDirection: 'row',backgroundColor: '#fffa85',borderRadius: 20,padding: 20,marginTop: 2,alignItems: 'center'}}>
                    ...
                    <View style={styles.ColumnContainer}>
                        ...
                        <Text style={styles.details}>* Omega-3 Fatty Acids – Supports brain and eye development</Text>
                        <Text style={styles.details}>* Foods: Foods: Salmon, walnuts, flax-seeds, eggs</Text>
                        <Text style={styles.details}>* Drinks: Almond milk, homemade vegetable juice</Text>
                    </View>
                ...
                <View id={"Exercises"} style={{flexDirection: 'row',backgroundColor: '#C0DEFF',borderRadius: 20,padding: 20,marginTop: 10,alignItems: 'center'}}>
                    ...
                    <View style={styles.ColumnContainer}>
                        ...
                        <Text style={styles.details}>* Physical: Light squats and leg lifts for strength</Text>
                        <Text style={styles.details}>* Mental: Listening to relaxing music or guided affirmations</Text>
                    </View>
                ...
                <View id={"Medicines & Vaccines  "} style={{flexDirection: 'row',backgroundColor: '#ADF2F6',borderRadius: 20,padding: 20,marginTop: 10,alignItems: 'center'}}>
                    ...
                    <View style={styles.ColumnContainer}>
                        ...
                        <Text style={styles.details}>* Omega-3 Fatty Acids (DHA) – Supports baby’s brain and eye development.</Text>
                        <Text style={styles.details}>* No new vaccines unless traveling to risk areas.</Text>
                    </View>
                </View>
